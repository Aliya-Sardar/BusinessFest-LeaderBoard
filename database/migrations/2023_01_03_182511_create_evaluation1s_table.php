...
class CreateEvaluation1sTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('evaluation1s', function (Blueprint $table) {
            $table->increments('id');
            $table->string('business_Name');
            $table->tinyInteger('HRM')->unsigned()->default(0);                             // HRM 10%
            $table->tinyInteger('Innovation')->unsigned()->default(0);                      // Innovation 15%
            $table->tinyInteger('Sustainibility')->unsigned()->default(0);                  // Sustainibility 15%
    ...
    {
        Schema::dropIfExists('evaluation1s');
    }
}
